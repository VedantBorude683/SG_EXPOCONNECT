...
export default function ProjectsPage() {
  const [selectedProject, setSelectedProject] = useState<{ name: string; category: string; description: string; image: string; brochureLink?: string } | null>(null);
  ...
  return (
    <main className="min-h-screen bg-[#FCFAF5] text-[#0A1931] overflow-hidden font-sans selection:bg-[#D4AF37] selection:text-white">
        ...
        <div className="fixed inset-0 z-50 bg-[#0A1931]/80 backdrop-blur-sm flex items-center justify-center p-4 md:p-8 animate-in fade-in duration-300">
          <div className="bg-white rounded-[2rem] w-full max-w-4xl max-h-[90vh] overflow-y-auto relative flex flex-col md:flex-row shadow-2xl animate-in zoom-in-95 duration-300">
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              ...
              {selectedProject.brochureLink && (
                <a
                  href={selectedProject.brochureLink}
                  download
                  className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-[#0A1931] px-6 py-3 rounded-full font-bold text-sm transition-all shadow-sm hover:shadow-md w-max"
                >
      ...
      {/* Current Projects & Brochure Highlight Section */}
      <section className="w-full bg-[#FCFAF5] py-24 px-6 relative overflow-hidden">
        ...
        {/* Current Projects Display (Asymmetrical Spotlight) */}
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
          ...
          <div
            ...
            className="lg:col-span-7 bg-white border border-gray-100 rounded-3xl overflow-hidden hover:shadow-xl transition-shadow duration-300 group flex flex-col sm:flex-row h-auto sm:h-[500px] cursor-pointer"
          >
